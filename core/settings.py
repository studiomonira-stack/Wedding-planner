...
MIDDLEWARE = [
    ...
    'accounts.middleware.ForceLanguageMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.photographer_context',
            ],
        },
    },
]
...
# Content Security Policy (CSP) – tillåt 
# iframes
...
WHOP_PLAN_ID = 'plan_Xq2qra99EegxU'
